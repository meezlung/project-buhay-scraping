...
class PhilAtlas:
    ...
    def get_district_number(self, barangay_name: str) -> int:
        ...
        if barangay_name == 'Santo Cristo' or barangay_name == 'Santo Domingo' or barangay_name == 'Sienna' or barangay_name == 'N. S. Amoranto':
            return 1
        elif barangay_name == 'Balong Bato':
            return 2
        elif barangay_name == 'Saint Ignatius' or barangay_name == 'Claro':
            return 3
        elif barangay_name == 'Teachers Village East' or barangay_name == 'Teachers Village West' or barangay_name == 'Aurora' or barangay_name == 'San Isidro':
            return 4
        elif barangay_name == 'Santa Lucia' or barangay_name == 'Santa Cruz' or barangay_name == 'Santa Monica':
            return 5
...
class WikipediaBarangay(PhilAtlas):
    ...
    def extract_districts(self, soup: BeautifulSoup) -> None:
        """ Extracts the barangay districts from the Wikipedia page and organizes them per district number via dictionary """
